...
public class ExampleData {
    ...
    public static void  main(String[] args) {
        ...
        Supplier magicMarket = new Supplier("magicMarket", "beans supplier");
        supplierDataStore.add(magicMarket);
        ...
        productDataStore.add(new Product("Mameshiba", 249.99f, "USD", "Dog-like faces and tell trivia. Their name derives from a series of puns.", productCategoryDataStore.find(1), supplierDataStore.find(1)));
        ...
        productDataStore.add(new Product("Bertie Botts", 890.55f, "USD", "They're back! It's the return of the infamous Bertie Bott's Every Flavour Beans! ", productCategoryDataStore.find(1), supplierDataStore.find(1)));
